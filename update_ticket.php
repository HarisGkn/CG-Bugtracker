...
require_once "config.php";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		mysqli_query($link, "UPDATE tickets SET summary='$summary', status='$status', to_user='$to_user', priority='$priority', description='$description' WHERE id=$id"); 
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
                                            ...
                                            <div class="form-group">
	                                    		...
	                                    		<input class="form-control" type="text" name="summary" placeholder="Write a summary of your issue" value="">
	                                    	</div>
	                                    	<div class="form-group">
